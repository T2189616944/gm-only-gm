...
// func Ecrecover2(hash, sig []byte) ([]byte, error) {
// 	panic("delete Ecrecover")
...
func EcrecoverWithPub(hash, sig []byte) ([]byte, error) {
	...
	pub, err := DecompressPubkey(sig[65:])
	if err != nil {
		panic("DecompressPubkey error  " + err.Error())
		return nil, err
	}
...
// func SigToPub2(hash, sig []byte) (*ecdsa.PublicKey, error) {
// 	panic("update to sig to pub2")
// 	s, err := Ecrecover2(hash, sig)
// 	if err != nil {
// 		return nil, err
// 	}
...
func SigToPubWithPub(hash, sig []byte) (*ecdsa.PublicKey, error) {
	...
	return DecompressPubkey(sig[65:])
}
...
func SignWithPub(digestHash []byte, prv *ecdsa.PrivateKey) (sig []byte, err error) {
	...
	pubKey := CompressPubkey(&prv.PublicKey)
